...
export const useRouteStore = defineStore(SetupStoreId.Route, () => {
   ...
   * "@elegant-router/vue"
   */
  const authRouteMode = ref((import.meta.env.VITE_AUTH_ROUTE_MODE as Env.AuthRouteMode) || 'static');

  /** Home route key */
  const routeHome = ref((import.meta.env.VITE_ROUTE_HOME as any) || ('user-manage_list' as any));
